...
struct ContentView: View {
    @AppStorage("android_ip", store: UserDefaults(suiteName: "group.com.yourname.ScreenMirror"))
    private var androidIP: String = "192.168.42.100"
    @AppStorage("android_port", store: UserDefaults(suiteName: "group.com.yourname.ScreenMirror"))
